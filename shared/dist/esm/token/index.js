                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (supportedTokensForNetwork) {
                            token = supportedTokensForNetwork.supportedTokens.find(function (c) { return getAddress(c.contractAddress, true) === contractAddress; });
                        ...
                        image = "https://github.com/jejaz/uniswap-dapp-integration-monorepo/tree/master/shared/src/token/logos/".concat(removeEthFromContractAddress(contractAddress), ".png");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
