...
var EthereumProvider = /** @class */ (function () {
    function EthereumProvider(_address, provider) {
        ...
        if (provider._isProvider) {
            ...
            this._ethersProvider = new ethers_1.providers.Web3Provider(provider);
        }
    }
    Object.defineProperty(EthereumProvider.prototype, "address", {
        /**
         * Get the ethereum address
         */
        get: function () {
            return ethers_1.utils.getAddress(this._address);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(EthereumProvider.prototype, "provider", {
        /**
     ...
     */
    EthereumProvider.prototype.sendAsync = function (transaction) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.provider.send('eth_sendTransaction', [transaction])];
    ...
    EthereumProvider.prototype.isSupportedChain = function (chainId, supportedNetworkTokens) {
        try {
            ...
            console.log('is supported chain ' + supportedNetworkTokens.find(function (t) { return t.chainId === chainId; }) !== undefined);
     ...
     */
    EthereumProvider.prototype.updateEthereumAddress = function (address) {
